...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://localhost.stackbit.com/pull/5ffc17d8bc00ee71a9855013
...
To start editing your site, you can use the Sanity interface at https://spectacular-chestnut-c17d8.sanity.studio/.
...
Generated at `2021-01-11T09:18:32.779Z` by Stackbit version `0.3.42`.